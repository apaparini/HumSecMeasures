...
xtreg HMII_peryear i.COLDWAR, re
eststo neor

**Running the path-dependent constructivist assumption regression**
xtreg HMII_peryear L.ENDTYPE L.NEWVIOL i.UNSC i.REGIOORG i.GOVTPERM, re 
eststo const

**Running a combined analysis**
xtreg HMII_peryear i.COLDWAR L.ENDTYPE L.NEWVIOL i.UNSC i.REGIOORG i.GOVTPERM, re 
eststo both
